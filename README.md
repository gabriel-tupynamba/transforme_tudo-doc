...
## 📱 Galeria e Funcionalidades Detalhadas

Para visualizar a interface da aplicação, os fluxos de ecrã e as regras de negócio de cada módulo, aceda à documentação visual abaixo:

* 🔐 **[1. Autenticação e Navegação Principal](docs/ui_autenticacao.md)**
* ⚙️ **[2. Criação de Fichas: Montador Dinâmico e Externas](docs/ui_montador.md)**
* 🎒 **[3. Arsenal de Fichas](docs/ui_arsenal.md)**
* 🏋️ **[4. Execução: Treino Ativo](docs/ui_treino_ativo.md)**
* 📈 **[5. Histórico, Estatísticas e Evolução](docs/ui_historico.md)**
---
